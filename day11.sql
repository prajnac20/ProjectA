...
INSERT INTO trandetails VALUES('T00012','A00007','2013-03-26 00:00:00','Cash','Withdrawal',2000);
...
select custid,fname,dob from customer order by dob ,fname asc;

select * from customer;
select custid,concat(concat(fname,' '),coalesce(mname,ltname))as Cust_Name from customer;
select a.acnumber,c.mobileno,c.fname,c.ltname,a.opening_balance from account a , customer c where c.custid= a.custid;
select count(custid) as cust_count from customer where city='Delhi';
